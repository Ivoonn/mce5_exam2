...
```{r}
library(readxl)
aedes <- read_excel("C:/Users/DELL/Desktop/EXAMEN RECUPERACIÓN - METODOS/aedes.xlsx")
View(aedes)
```
...
```{r}
library(readxl)
leishmania <- read_excel("C:/Users/DELL/Desktop/EXAMEN RECUPERACIÓN - METODOS/leishmania.xlsx")
View(leishmania)
```
...
```{r}
library(readxl)
disease <- read_excel("C:/Users/DELL/Desktop/EXAMEN RECUPERACIÓN - METODOS/disease.xlsx")
View(disease)
```
...
```{r}
library(ggplot2)
ggplot(data = disease, aes(x =  age, y = native, 
                         col = treatment)) + 
...
```{r}
library(readxl)
hepatitis <- read_excel("C:/Users/DELL/Desktop/EXAMEN RECUPERACIÓN - METODOS/hepatitis.xlsx")
View(hepatitis)
```
